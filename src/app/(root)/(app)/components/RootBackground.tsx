    ...
    <>
      ...
      <div className="fixed left-0 top-0 h-full w-full overflow-hidden bg-white dark:bg-black">
        <Image
          ...
          className={'block h-full w-full object-cover object-[calc(50%+1rem)_center]'}
        />
        {isVideoPlayed && (
          <video
            ...
            loop
            autoPlay
            className={'absolute top-0 z-10 block h-full w-full object-cover object-[calc(50%+1rem)_center]'}
          />
        )}
      </div>
    </>
